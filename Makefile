...
SFML_SOURCES = main_sfml.cpp src/views/GameView.cpp src/views/LevelView.cpp src/views/EnemyView.cpp src/views/TowerView.cpp src/views/HUDView.cpp src/controllers/TowerPlacementController.cpp
